...
import pandas as pd
from raifhack.features import prepare_categorical
...
from raifhack.settings import LOGGING_CONFIG, NUM_FEATURES, CATEGORICAL_OHE_FEATURES, \
    CATEGORICAL_STE_FEATURES, CENTER_MSK_LAT, CENTER_MSK_LNG, ENCODED_NUM_CAT_FEATURES
...
if __name__ == "__main__":
    ...
    try:
        ...
        logger.info('Predict')
        test_df['per_square_meter_price'] = model.predict(test_df[NUM_FEATURES+CATEGORICAL_OHE_FEATURES+CATEGORICAL_STE_FEATURES]) * 0.94
